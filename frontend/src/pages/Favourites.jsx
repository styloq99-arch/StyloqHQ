  ...
  return (
    <div className="app-layout">
      ...
      <div className="main-content">
        ...
        {/* No search results */}
        {favouriteList.length > 0 && filtered.length === 0 && (
          <div className="fav-no-results">
            <i className="fas fa-search fav-no-results__icon"></i>
            <p>No saved posts match "<strong className="fav-no-results__query">{searchQuery}</strong>"</p>
            <button onClick={() => setSearchQuery('')} className="fav-no-results__clear">
              Clear search
            </button>
          </div>
        )}
