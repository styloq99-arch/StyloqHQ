  ...
  return (
    <div className="app-layout">
      ...
      <div className="content-side" style={{ overflow: "hidden", padding: "0" }}>
        ...
        {/* Buttons */}
        <motion.div 
          className="buttons-wrapper mobile-btn-wrapper"
          initial={{ y: 15, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
          transition={{ duration: 0.5, ease: "easeOut", staggerChildren: 0.1 }}
        >
          <MotionLink whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} to="/signin" className="btn btn-primary">SIGN IN</MotionLink>
          <MotionLink whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} to="/signup-customer" className="btn btn-secondary">SIGN UP AS A CUSTOMER</MotionLink>
          <MotionLink whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} to="/signup-barber" className="btn btn-secondary">SIGN UP AS A BARBER</MotionLink>
          <MotionLink whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} to="/signup-salon" className="btn btn-secondary">SIGN UP AS A SALON</MotionLink>
        </motion.div>
